        ...
        return (
          <div className="card">
            ...
            <div className="card-body">
              ...
              <a className="btn btn-sm btn-primary float-right" onClick={()=>{this.triggerParentEdit()}}>Manage</a>
              <a className="btn btn-sm btn-danger float-right" onClick={() => {
...
export default connect(mapStateToProps,{deleteProduct,addFlashMessage})(UserProductItem);
