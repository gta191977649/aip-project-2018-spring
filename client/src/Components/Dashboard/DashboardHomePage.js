          ...
          <Col md="12">
            ...
            <Row>
              <Col md="4">
                <Card>
                  <CardBody>
                    <Fa icon="users" size="3x" className="float-left light-blue-text" />
              ...
              <Col md="4">
                <Card>
                  <CardBody>
                    <Fa icon="cny" size="3x" className="float-left light-green-text" />
                    <div className="text-right">
                      <h4>Purchases</h4>
                      9,280
                  </div>
              ...
              <Col md="4">
                <Card>
                  <CardBody>
                    <Fa icon="shopping-cart" size="3x" className="float-left pink-text" />
                    <div className="text-right">
                      <h4>Shoppings</h4>
                      13,600
                  </div>
